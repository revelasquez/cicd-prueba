...
return new class extends Migration
{
    ...
    {
        Schema::table('eco_com_once_payments', function (Blueprint $table) {
    ...
    {
        Schema::table('eco_com_once_payments', function (Blueprint $table) {
            $table->dropForeign('eco_com_once_payments_city_birth_id_foreign');
            $table->dropForeign('eco_com_once_payments_economic_complement_id_foreign');
        });
    }
};
