...
return new class extends Migration
{
    ...
    {
        Schema::table('ret_fun_beneficiaries', function (Blueprint $table) {
            $table->dropForeign('ret_fun_beneficiaries_city_identity_card_id_foreign');
            $table->dropForeign('ret_fun_beneficiaries_kinship_id_foreign');
            $table->dropForeign('ret_fun_beneficiaries_retirement_fund_id_foreign');
        });
    }
};
