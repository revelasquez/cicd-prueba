...
return new class extends Migration
{
    ...
    {
        Schema::table('eco_com_rents', function (Blueprint $table) {
            $table->dropForeign('eco_com_rents_degree_id_foreign');
            $table->dropForeign('eco_com_rents_procedure_modality_id_foreign');
            $table->dropForeign('eco_com_rents_user_id_foreign');
        });
    }
};
